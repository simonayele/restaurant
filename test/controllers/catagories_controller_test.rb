...
class CatagoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catagory" do
    assert_difference('Catagory.count') do
      post catagories_url, params: { catagory: { body: @catagory.body, display: @catagory.display, heading: @catagory.heading } }
    end
  ...
  test "should update catagory" do
    patch catagory_url(@catagory), params: { catagory: { body: @catagory.body, display: @catagory.display, heading: @catagory.heading } }
